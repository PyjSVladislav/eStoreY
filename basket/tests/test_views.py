...
class TestBasketView(TestCase):
    ...
    def setUp(self):
        ...
        Product.objects.create(category_id = 1, title = 'django beginners',
                                    created_by_id = 1, slug = 'django_beginners',
                                    price = '20.00', image = 'django')
        Product.objects.create(category_id = 1, title = 'django inter',
                                    created_by_id = 1, slug = 'django_inter',
                                    price = '20.00', image = 'django')
        Product.objects.create(category_id = 1, title = 'django advans',
                                    created_by_id = 1, slug = 'django_advans',
                                    price = '20.00', image = 'django')
        self.client.post(
